...
function makeBuiltins(fsScope) {
  ...
  variables['sleep-sync'] = new lib.Variable(new lib.LFunction(function (_ref5) {
  ...
  variables['^'] = new lib.Variable(new lib.LFunction(function (_ref15) {
  ...
  variables['not'] = new lib.Variable(new lib.LFunction(function (_ref17) {
  ...
  variables['and'] = new lib.Variable(new lib.LFunction(function (_ref19) {
  ...
  variables['or'] = new lib.Variable(new lib.LFunction(function (_ref21) {
  ...
  variables['lt'] = new lib.Variable(new lib.LFunction(function (_ref23) {
  ...
  variables['gt'] = new lib.Variable(new lib.LFunction(function (_ref25) {
  ...
  variables['eq'] = new lib.Variable(new lib.LFunction(function (_ref27) {
  ...
  variables['is'] = new lib.Variable(new lib.LFunction(function (_ref29) {
  ...
  variables['loop'] = new lib.Variable(new lib.LFunction(function (_ref31) {
  ...
  variables['use'] = new lib.Variable(new lib.LFunction(function (_ref33) {
    var _ref34 = (0, _slicedToArray3.default)(_ref33, 1);

    var pathStr = _ref34[0];
  ...
  variables['launch'] = new lib.Variable(new lib.LFunction(function (_ref35) {
  ...
  lib.set(variableObject, 'make', new lib.LFunction(function (_ref37) {
    var _ref38 = (0, _slicedToArray3.default)(_ref37, 3);
  ...
  lib.set(variableObject, 'change', new lib.LFunction(function (_ref39) {
    var _ref40 = (0, _slicedToArray3.default)(_ref39, 2);

    var variable = _ref40[0];
    var newValue = _ref40[1];

    variable.value = newValue;
  }));

  lib.set(variableObject, 'value', new lib.LFunction(function (_ref41) {
    var _ref42 = (0, _slicedToArray3.default)(_ref41, 1);

    var variable = _ref42[0];

    return variable.value;
  }));

  lib.set(variableObject, 'from', new lib.LFunction(function (_ref43) {
  ...
  lib.set(variableObject, 'exists', new lib.LFunction(function (_ref45) {
  ...
  lib.set(environmentObject, 'break-to', new lib.LFunction(function (_ref47) {
    var _ref48 = (0, _slicedToArray3.default)(_ref47, 2);

    var toEnv = _ref48[0];
    var fromEnv = _ref48[1];

    fromEnv.breakToEnvironment = toEnv;
  }));

  lib.set(environmentObject, 'set-comment', new lib.LFunction(function (_ref49) {
    var _ref50 = (0, _slicedToArray3.default)(_ref49, 2);

    var env = _ref50[0];
    var comment = _ref50[1];
  ...
  variables['set-timeout'] = new lib.Variable(new lib.LFunction(function (_ref51) {
