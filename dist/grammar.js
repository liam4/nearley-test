...
(function () {
  ...
  var grammar = {
    ParserRules: [{ "name": "_$ebnf$1", "symbols": [] }, { "name": "_$ebnf$1", "symbols": ["wschar", "_$ebnf$1"], "postprocess": function arrconcat(d) {
      ...
      } }, { "name": "GetPropertyUsingKeyExpression", "symbols": ["Expression", "_", { "literal": ":" }, "_", "Expression"], "postprocess": function postprocess(d) {
        return [C.GET_PROP_USING_KEY, d[0], d[4]];
