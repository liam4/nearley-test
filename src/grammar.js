...
var grammar = {
    ...
    {"name": "VariableAssign", "symbols": ["Identifier", "__", "VariableAssign$string$1", "__", "Expression"], "postprocess": function(d) { return [C.VARIABLE_ASSIGN, d[0], d[4]] }},
    {"name": "VariableChange$string$1", "symbols": [{"literal":"-"}, {"literal":">"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "VariableChange", "symbols": ["Identifier", "__", "VariableChange$string$1", "__", "Expression"], "postprocess": function(d) { return [C.VARIABLE_CHANGE, d[0], d[4]] }},
