...
var grammar = {
    ...
    {"name": "_Expression", "symbols": ["GetPropertyUsingKeyExpression"]},
    ...
    {"name": "GetPropertyUsingKeyExpression", "symbols": ["Expression", "_", {"literal":":"}, "_", "Expression"], "postprocess": function(d) { return [C.GET_PROP_USING_KEY, d[0], d[4]] }},
